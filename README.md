...
## Documentation
It's a sound Wrapper for PJSIP on QNX, the alsa_dev.c file is altered to qnx_dev.c in order to make audio work on QNX. The PJSIP project i.e. pjproject can be cross compiled for QNX as mentioned below.

Install QNX SDP and QNXd710 and activate the QNX license, qnxsdp-env.sh is the shell script to set QNX Enviroment variable.
